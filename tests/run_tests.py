...
TEST_GROUPS = {
    ...
    "threshold": [
        ...
        "tests/unit/test_threshold_ai.py",
        "tests/unit/test_threshold_confidence.py",
        "tests/unit/test_threshold_contracts.py",
        "tests/unit/test_threshold_evidence.py",
        "tests/unit/test_threshold_example_rules.py",
        "tests/unit/test_threshold_gate.py",
        "tests/unit/test_threshold_policy.py",
        "tests/unit/test_threshold_replay_fixtures.py",
